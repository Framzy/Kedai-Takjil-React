    ...
    <>
      ...
      >
        <div className="w-full flex flex-col md:flex-row justify-between items-center">
          <h3 className="text-[var(--color-gray)] text-lg font-bold">
            | {label}
          </h3>
          <Link
            to="/products"
            className="text-[var(--color-primary)] text-md md:text-lg font-bold hover:text-[var(--color-secondary)] transition-colors duration-300"
          >
            Lihat Semua
          </Link>
        </div>
