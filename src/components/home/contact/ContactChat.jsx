  ...
  return (
    <>
      <div className="h-26 md:h-32 xl:h-40 flex justify-start items-center gap-2">
        <div className="w-8 md:w-12 xl:w-18 h-full flex justify-start items-start gap-2 ">
          <img src={img} alt={label} className="h-auto" />
        </div>
        <div className="w-full h-full flex flex-col justify-start items-start gap-2 ">
          <h2 className="text-md md:text-lg xl:text-xl font-bold py-0 md:py-2 xl:py-4 text-gray-600 ">
            {label}
          </h2>
